...
|string
|_MarketCap_ symbol (ex: _NEO_). Only supported when _type_ is _service_ and _id_ is _marketCap_
...
* conditions : _buy price on binance for NEO-USDT > 130.5_ AND _price for NEO in MarketCap module in range [120,125]_
